...
**Software UX Designer** · Persona-Driven Research, Design Systems, AI-Augmented Build | Greater Seattle Area  
LinkedIn: [linkedin.com/in/davidtrick/](http://linkedin.com/in/davidtrick/)
...
**Core Competencies:** UX Design · Design Systems & Standards · Persona-Driven Research · CloudScape · Figma & Figma Make · React/TypeScript · GraphQL · AWS CDK · AI Agent Design · Accessibility (WCAG) · Visual Design · Branding & Typography · 3D Modeling · Industrial HMI · BMS/EPMS/SCADA

---

## Professional Experience

### Design Technologist II — Amazon Web Services

_August 2022 – Present | Greater Seattle Area_
...
- Led cross-organization terminology standardization across 4 organizations; 6 naming decisions adopted platform-wide- Team's UI/UX approver on cross-team code reviews — design-system compliance, accessibility, and persona-impact callouts as a recurring contribution
...
- Authored north-star design vision: **widget-based atomic units → persona-templated dashboards → deep-dive experiences**, with all 20 personas mapped to default templates and a defined customization lifecycle- Presented the dashboards live on the UX Standards Website to immediate leadership — first leadership exposure to the persona-driven UX vision **as a working UX model** rather than static mockups

**AI-Augmented Design-to-Build**

- Built an **AI development agents package** with 39 validated capabilities (16 skills, 1 agent, 3 SOPs, 19 context files) approved by the team; created a unified audit-aware page generator producing standards-compliant React/CloudScape from natural-language descriptions- Pioneered **Figma Make → React rapid prototyping pipeline**; 6 AI-generated mockups translated into 4 interactive persona dashboard implementations
- Designed an **AI-powered sprint management system** where agents autonomously manage boards, create punt clones, and track velocity- Standards violations now affect code reviews with persona feedback shipping as non-blocking advisory cards
...
### Controls Design Engineer — Amazon Web Services

_April 2017 – August 2022 | Greater Seattle Area_

_Hired as Graphics Engineer; promoted to L5 in December 2018; progressed through multiple levels of Controls Design Engineering before transitioning to Design Technologist._
...
- Established the **centralized Graphics Repository** for completed SVG artwork across all sites and authored the definitive SVG floorplan annotation runbook (shared 7+ times to onboard team members)- Audited BMS graphics across all legacy US data centers against 62 graphical standard elements; produced ROI-ranked 3-phase remediation plan (~4,600 hours estimated, ~$730K) and pitched the program to senior leadership
...
**Curriculum Developer & Instructor — Blaze Education, Inc.** _(Jan 2017 – Mar 2017, Redmond, WA)_  
...
**Design Engineer — UW Hyperloop** _(Mar 2016 – Aug 2016, Seattle, WA)_  
...
**Teaching Assistant & Lab Assistant — University of Washington, ME Department** _(Sep 2014 – Dec 2015)_  
...
**Freelance Designer — Syncopated Design** _(May 2010 – Sep 2014)_  
...
Standalone reference site that serves a dual purpose: documents the platform's UX standards (page types, components, audit rules, accessibility requirements) and provides a customer-interactive and customizable mockup for persona-based landing page dashboards.

**AI-Powered Page Auditing Agent** _(Owner, 2024 – Present)_  
Custom AI agent for automated auditing of platform pages against design and coding standards; published as a shared team package and integrated into CI — affects code reviews on standards violations while keeping persona feedback as non-blocking suggestions.

---

## Education

**Bachelor of Science, Mechanical Engineering** — University of Washington _(2014 – 2016, GPA 3.42)_  
Capstone: EcoCar (machining, SolidWorks drawings, manufacturing of connective components). Independent research: UW Hyperloop test bench design for magnetic levitation. ASME and ASHRAE student member.  
_Honors: Roy & Irene Grossman Memorial Scholarship; Roy C. Fellows Endowed Scholarship (Sept 2015)._

**Bachelor of Fine Arts, Visual Communications — Graphic Design** — University of Arizona _(2002 – 2008, GPA 3.84, Magna Cum Laude)_  
Additional emphasis in Motion Graphics. Member of IEEE.

---

## Certifications

- **Figma Essential Training: The Basics** — LinkedIn Learning _(April 2022)_
- **Revit: MEP Families** — LinkedIn Learning _(August 2021)_
- **Cert Prep: Revit Architecture Certified Professional** — LinkedIn Learning

---

## Technical Skills

**Design & UX:** Figma, Figma Make, CloudScape Design System, Adobe Creative Suite (Illustrator, Photoshop, InDesign), Inkscape, design systems, prototyping, wireframing, accessibility (WCAG), persona research, customer validation  
**Front-End:** React, TypeScript, JavaScript, HTML5, CSS3, SVG, D3.js, component architecture, state management, responsive design  
**Back-End & Cloud:** GraphQL, Java, Python, AWS CDK, CloudFront, Route 53, ACM, S3, Lambda, REST APIs  
**AI & Automation:** Kiro (AI-powered IDE), Amazon Q, AI agent design, AI capabilities packaging, workflow automation  
**3D / CAD:** SolidWorks, Revit, AutoCAD, 3D printing, additive manufacturing, technical drawing  
**Industrial:** BMS, EPMS, SCADA, HMI, PLC, Ignition Systems
...
**Security Officer** — Baha'i World Centre _(May 2003 – May 2004, Haifa and Akka, Israel)_  
Maintained security presence and coordinated with local guards across a multicultural environment alongside 750+ international volunteers; performed gate, building, and grounds checks; volunteered additionally in gardening, facilities, and visitor guidance.

---

## Professional Recommendation

> "David is a talented mechanical engineer. He is responsible, hard-working, and a team-player. His passion for engineering learning goes beyond the classroom."  
> — **Nate Sniadecki**, Professor at University of Washington _(November 2016)_